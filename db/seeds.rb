...
#trailers
movie1.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/holy_mountain.mp4'), filename: 'holy_mountain.mp4')
movie2.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/seven_samurai.mp4'), filename: 'seven_samurai.mp4')
movie3.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/amarcord.mp4'), filename: 'amarcord.mp4')
movie4.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/seventh_seal.mp4'), filename: 'seventh_seal.mp4')
movie5.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/yojimbo.mp4'), filename: 'yojimbo.mp4')
movie6.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/withnail_and_i.mp4'), filename: 'withnail_and_i.mp4')
movie7.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/ruling_class.mp4'), filename: 'ruling_class.mp4')
movie8.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/rashomon.mp4'), filename: 'rashomon.mp4')
movie9.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/8_1_2.mp4'), filename: '8_1_2.mp4')
movie10.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/la_strada.mp4'), filename: 'la_strada.mp4')
movie11.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/kagemusha.mp4'), filename: 'kagemusha.mp4')
movie12.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/harakiri.mp4'), filename: 'harakiri.mp4')
movie13.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/virgin_spring.mp4'), filename: 'virgin_spring.mp4')
movie14.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/bicycle_thieves.mp4'), filename: 'bicycle_thieves.mp4')
movie15.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/pierrot_le_fou.mp4'), filename: 'pierrot_le_fou.mp4')
movie16.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/bottle_rocket.mp4'), filename: 'bottle_rocket.mp4')
movie17.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/the_exterminating_angel.mp4'), filename: 'the_exterminating_angel.mp4')
movie18.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/paths_of_glory.mp4'), filename: 'paths_of_glory.mp4')
movie19.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/house.mp4'), filename: 'house.mp4')
movie20.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/cronos.mp4'), filename: 'cronos.mp4')
movie21.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/great_dictator.mp4'), filename: 'great_dictator.mp4')
movie22.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/black_moon.mp4'), filename: 'black_moon.mp4')
movie23.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/casablanca.mp4'), filename: 'casablanca.mp4')
movie24.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/come_and_see.mp4'), filename: 'come_and_see.mp4')
movie25.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/belladonna_of_sadness.mp4'), filename: 'belladonna_of_sadness.mp4')
movie26.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/akira.mp4'), filename: 'akira.mp4')
movie27.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/spirited_away.mp4'), filename: 'spirited_away.mp4')
movie28.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/witch.mp4'), filename: 'witch.mp4')
movie29.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/suspiria.mp4'), filename: 'suspiria.mp4')
movie30.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/night_of_the_hunter.mp4'), filename: 'night_of_the_hunter.mp4')
movie31.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/life_aquatic.mp4'), filename: 'life_aquatic.mp4')
movie32.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/manhattan.mp4'), filename: 'manhattan.mp4')
movie33.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/hannah_and_her_sisters.mp4'), filename: 'hannah_and_her_sisters.mp4')
movie34.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/heavy_metal.mp4'), filename: 'heavy_metal.mp4')
movie35.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/heavy_traffic.mp4'), filename: 'heavy_traffic.mp4')
movie36.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/wizards.mp4'), filename: 'wizards.mp4')
movie37.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/new_hope.mp4'), filename: 'new_hope.mp4')
movie38.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/running_man.mp4'), filename: 'running_man.mp4')
movie39.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/buckaroo_bonzai.mp4'), filename: 'buckaroo_bonzai.mp4')
movie40.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/end_of_evangelion.mp4'), filename: 'end_of_evangelion.mp4')
movie41.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/castle_of_cagliostro.mp4'), filename: 'castle_of_cagliostro.mp4')
movie42.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/princess_mononoke.mp4'), filename: 'princess_mononoke.mp4')
movie43.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/howls_moving_castle.mp4'), filename: 'howls_moving_castle.mp4')
movie44.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/my_neighbor_totoro.mp4'), filename: 'my_neighbor_totoro.mp4')
movie45.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/princess_kaguya.mp4'), filename: 'princess_kaguya.mp4')
movie46.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/watership_down.mp4'), filename: 'watership_down.mp4')
movie47.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/fantastic_planet.mp4'), filename: 'fantastic_planet.mp4')
movie48.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/triplets_of_belleville.mp4'), filename: 'triplets_of_belleville.mp4')
movie49.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/roger_rabbit.mp4'), filename: 'roger_rabbit.mp4')
movie50.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/secret_of_kells.mp4'), filename: 'secret_of_kells.mp4')
movie51.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/song_of_the_sea.mp4'), filename: 'song_of_the_sea.mp4')
movie52.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/three_days_of_the_condor.mp4'), filename: 'three_days_of_the_condor.mp4')
movie53.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/big_sleep.mp4'), filename: 'big_sleep.mp4')
movie54.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/alien.mp4'), filename: 'alien.mp4')
movie55.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/omen.mp4'), filename: 'omen.mp4')
movie56.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/face_of_another.mp4'), filename: 'face_of_another.mp4')
movie57.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/pans_labyrinth.mp4'), filename: 'pans_labyrinth.mp4')
movie58.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/eyes_wide_shut.mp4'), filename: 'eyes_wide_shut.mp4')
movie59.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/usual_suspects.mp4'), filename: 'usual_suspects.mp4')
movie60.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/shining.mp4'), filename: 'shining.mp4')
movie61.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/wicker_man.mp4'), filename: 'wicker_man.mp4')
movie62.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/killing_of_a_sacred_deer.mp4'), filename: 'killing_of_a_sacred_deer.mp4')
movie63.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/uncut_gems.mp4'), filename: 'uncut_gems.mp4')
movie64.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/big_lebowski.mp4'), filename: 'big_lebowski.mp4')
movie65.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/duck_soup.mp4'), filename: 'duck_soup.mp4')
movie66.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/superbad.mp4'), filename: 'superbad.mp4')
movie67.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/raising_arizona.mp4'), filename: 'raising_arizona.mp4')
movie68.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/tampopo.mp4'), filename: 'tampopo.mp4')
movie69.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/clue.mp4'), filename: 'clue.mp4')
movie70.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/holy_grail.mp4'), filename: 'holy_grail.mp4')
movie71.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/meaning_of_life.mp4'), filename: 'meaning_of_life.mp4')
movie72.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/life_of_brian.mp4'), filename: 'life_of_brian.mp4')
movie73.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/i_love_you_man.mp4'), filename: 'i_love_you_man.mp4')
movie74.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/dark_crystal.mp4'), filename: 'dark_crystal.mp4')
movie75.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/space_odyssey.mp4'), filename: 'space_odyssey.mp4')
movie76.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/brazil.mp4'), filename: 'brazil.mp4')
movie77.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/empire_strikes_back.mp4'), filename: 'empire_strikes_back.mp4')
movie78.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/return_of_the_jedi.mp4'), filename: 'return_of_the_jedi.mp4')
movie79.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/total_recall.mp4'), filename: 'total_recall.mp4')
movie80.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/blade_runner.mp4'), filename: 'blade_runner.mp4')
movie81.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/flash_gordon.mp4'), filename: 'flash_gordon.mp4')
movie82.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/starship_troopers.mp4'), filename: 'starship_troopers.mp4')
movie83.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/millers_crossing.mp4'), filename: 'millers_crossing.mp4')
movie84.trailer.attach(io: open('https://jefflix-seeds.s3-us-west-1.amazonaws.com/trailers/trailers/reservoir_dogs.mp4'), filename: 'reservoir_dogs.mp4')
